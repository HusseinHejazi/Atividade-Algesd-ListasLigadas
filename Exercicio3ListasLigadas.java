...
class ListaLigadaSimples
{
   ...
   public boolean crescente(){
     ...
     public Nodo procurar(int elemento)
   {
      Nodo aux=inicio;
      while(aux != null)
      {  System.out.println("Procurando no endereço " + aux);
         if(aux.dado == elemento)
            return aux;
         else aux = aux.link;
      }
   ...
   public Nodo procurarRec(Nodo inicio, int elemento)
   {    if(inicio==null) return null;
        else if(inicio.dado == elemento) return inicio;
        else return procurarRec(inicio.link, elemento);
   }
}

public class Exercicio3ListasLigadas

{
   public static void main(String args[])
   {
      ...
      System.out.println("Vamos procurar o 8: " + lista.procurar(8));
      System.out.println("Vamos procurar o 15: " + lista.procurar(15));
      System.out.println("Vamos procurar o 8: " +
        lista.procurarRec(lista.inicio, 8));
      System.out.println("Vamos procurar o 15: " +
        lista.procurarRec(lista.inicio, 15));
