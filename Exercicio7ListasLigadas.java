...
class ListaLigadaSimples
{
   ...
   public void concatenar(ListaLigadaSimples lista2)
   {
       this.quantidade = this.quantidade + lista2.quantidade;
       this.fim.link = lista2.inicio;
       this.fim = lista2.fim;
   }
         
}

public class Exercicio7ListasLigadas
